...
class TenantRegistrationAPIView(APIView):
    ...
    def post(self, request):
        ...
        if serialized_data.is_valid():
            ...
            confirm_link = f' http://127.0.0.1:8000/tenants/active/{user_id}/{token}/'
            email_subject = 'Confirm Your Account'
            email_body = render_to_string('tenant_confirmation.html', {
                'user': user,
...
class TenantDataByUserIDView(APIView):
    ...
    def get(self, request, format=None):
        ...
        try:
            user = Tenant.objects.get(user=user_id)
